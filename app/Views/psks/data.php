                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Data Potensi Sumber Kesejahteraan Sosial(PPKS)</h6>
                        </div>
                        <div class="card-body">
                            ...
                            <form id="myForm" class="row g-3" action="/psks/tampil" method="POST" enctype="multipart/form-data">
                            <?= csrf_field(); ?>
                                <div class="col-2">
                                    <input type="text" readonly class="form-control-plaintext" id="staticEmail2" value="Pilih Jenis PPKS ">
                                </div>
                                <div class="col-auto">
                                <select class="browser-default custom-select" name="psks" id="psks">
                                    <option selected="0">Semua PPKS</option>
                                    <?php foreach ($tampil as $h ) :?>
                                            <option value="<?= $h['id_psks']; ?>"><?= $h['nama_psks']; ?></option>
                                    <?php endforeach; ?>
                                </select>
                                </div>
                                <div class="col-auto">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary"> Hasil Data Potensi Sumber Kesejahteraan Sosial (PPKS)</h6>
                        </div>
                        ...
                        <div class="card-body">
                                ...
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <!-- <td>
                                                <center>
                                                <input type="checkbox" name="checked[]" class="check" value="<?= $d->id_pks;?>">
                                                </center>
                                            </td> -->
                                            <td><?= $d->nama_psks; ?></td>
                                            <td><?= $d->nik; ?></td>
                                            ...
                                            <td>
                                               ...
                                               data-desa="<?= $d->desa; ?>"
                                               data-pmks="<?= $d->nama_psks; ?>"
                                               ><i class="fa fa-edit"></i></button>
                                               <a href="/psks/delete/<?= $d->id_pks;?>" class="tombol-hapus"><button class="btn btn-danger"><i class="fa fa-trash"></i></button></a>
                                            </td>
                                        </tr>
                                        <?php endforeach; ?>
                                        <?php else: ?>
                            ...
                            <!-- Modal Edit Product-->
                            <form action="/psks/update" method="post">
                            <?= csrf_field(); ?>
                                ...
                                <div class="modal-dialog" role="document">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            <input type="text" class="form-control product_name" name="id" id="id">
                                        </div>
                                        <div class="form-group">
